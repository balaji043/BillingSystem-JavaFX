...
public class SingleProductController extends HBox {
    @FXML
    private JFXTextField name, hsn, qty, rate, discount;
    @FXML
    private Label amount;
    @FXML
    private JFXComboBox<String> per;
    @FXML
    ...
    public SingleProductController() {
        FXMLLoader fxmlLoader = BillingSystemUtils.getFXMLLoader(Views.SINGLE_PRODUCT);
    ...
    public String isReady() {
        ...
        if ((name.getText() == null || name.getText().isEmpty()
                ...
                || per.getValue() == null) || (checkBoxDiscount.isSelected() && checkBoxAdd.isSelected())
        ...
        if (checkBoxDiscount.isSelected() || checkBoxAdd.isSelected()) {
            ...
            else if (checkBoxDiscount.isSelected())
                rates = String.format("%.2f", r - val);
            else
