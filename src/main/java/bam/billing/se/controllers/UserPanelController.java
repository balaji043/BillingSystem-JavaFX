...
import bam.billing.se.helpers.DatabaseHelper_User;
...
import static bam.billing.se.utils.Constants.UserRole;
...
public class UserPanelController {
    ...
    public void setMainApp(Main main) {
        accessComboBox.getItems().addAll(UserRole.userRoleList);
        this.mainApp = main;
        initTable();
