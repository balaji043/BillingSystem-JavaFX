...
import bam.billing.gst.utils.ResourceConstants.Views;
...
public class SingleProductController extends HBox {
    ...
    public SingleProductController() {
        FXMLLoader fxmlLoader = Views.getFXMLLoaderWithUrl(Views.SINGLE_PRODUCT);
    ...
    private boolean checkComboBox(JFXComboBox<String> jfxComboBox) {
