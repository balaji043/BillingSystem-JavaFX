...
public class BillingSystemUtils {
    ...
    public static void setImageViewToButtons(ICON iconName, JFXButton jfxButton) {
        ...
        try {
            view1 = new ImageView(new Image(Main.class.
                    getResourceAsStream(iconName.toString())
                    , i + 10, i + 10, true, true));
        } catch (Exception e) {
        ...
        jfxButton.setTooltip(new Tooltip(iconName.toolTip));
    ...
    public static Image getImage(ICON iconPath) {
        return new Image(Main.class.getResourceAsStream(iconPath.toString()));
    }
