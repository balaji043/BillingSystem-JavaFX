...
public class BillService {
     ...
     */
    public static boolean insertNewBill(Bill bill, String tableName) {
    ...
    public static ObservableList<Bill> getBillList(String customer
            , LocalDate a, LocalDate b, String tableName) {
        ObservableList<Bill> bill = FXCollections.observableArrayList();
    ...
    public static ObservableList<Bill> getBillList(boolean b, String tableName) {
        ObservableList<Bill> bill = FXCollections.observableArrayList();
        PreparedStatement preparedStatement = null;
    ...
    public static boolean deleteBill(String billId, String tableName) {
        boolean okay = false;
        PreparedStatement preparedStatement = null;
        try {
