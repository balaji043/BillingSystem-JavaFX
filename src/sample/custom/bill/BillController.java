...
public class BillController implements GenericBillController {
    @FXML
    ...
    public void setBill(Bill bill) {
        ...
        Customer customer = DatabaseHelperCustomer.getCustomerInfo(bill.getCustomerName());
        if (customer != null) {
