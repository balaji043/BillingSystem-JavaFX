...
public class DatabaseHelperPurchaseBill {

    private static final Logger logger = Logger.getLogger(DatabaseHelperPurchaseBill.class.getName());

    private static final String TABLE_NAME = "PURCHASEBILLS";

    private DatabaseHelperPurchaseBill() {
